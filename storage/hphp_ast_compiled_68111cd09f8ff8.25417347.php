<?php extract(Piewpiew\view\View::$view_vars['pages/departement/components/_forms']->get_data()); ?><div id="addPrevisionForm" class="hidden">
  ...
  <form action="<?= route('departements/previsions') ?><?= add_annee() ?>" method="post" class="p-5 bg-light col-md-7 mx-auto border rounded-4">
    ...
    <div class="mb-3">
      ...
      <select
        ...
        <?php foreach($categorie_models as $categorie): ?>
